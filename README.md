...
3) Work very often in prefabs instead of scenes.
     A scene is unique, and if someone pushes changes to overwrite someone elses, work gets deleted
     Prefabs are not unique to scenes, so if people are working in different prefabs, scene changes won't afffect the prefabs.

Please bother Karan with questions so we don't break eachother's work. Files can be delicate. Good luck!!
